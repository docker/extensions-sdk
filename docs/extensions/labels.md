...
| `com.docker.extension.screenshots` | No | A JSON array of image titles and URLs, to be displayed in the details dialog, in the order on which they’ve been defined. | `"[{"title": "image 1", "url": "https://foo.bar/image1.png"},{"title": "image2", "url": "https://foo.bar/image2.jpg"}]"` |
